    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-background/80 p-4">
      <Card className="w-full max-w-md">
        ...
        <Tabs
          value={activeTab}
          onValueChange={(tab) =>
            setActiveTab(tab as "login" | "signup" | "forgot")
          }
          className="w-full"
        >
              ...
              <CardContent className="space-y-4 pt-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3 text-sm text-blue-800">
                  <h4 className="flex items-center font-medium mb-2">
                    ...
                    <strong className="px-2">Islam Abu Hamar</strong>{" "}
                  </h4>
                </div>
              </CardContent>
              <CardFooter>
          ...
          <div className="space-y-4 py-4">
            <div className="bg-amber-50 border border-amber-200 rounded-md p-4 text-sm text-amber-800">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Click the verification link in the same browser you used to
                  sign up
                </li>
                <li>
                  If you see a "This site can't be reached" error, try opening
                  the link in this browser window
                </li>
                <li>
                  The URL should redirect to this application automatically
                </li>
                <li>
                  Verification links may expire after a certain period of time
                </li>
                <li>
